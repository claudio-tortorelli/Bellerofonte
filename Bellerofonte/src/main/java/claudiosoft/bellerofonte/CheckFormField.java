...
class CheckFormField extends Single_test implements Serializable
{
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----	
		...
		_expectedField = (String)parameters.elementAt(2); //read words from file test txt or xml			
/////////////////////////// END OF COMMON CHANGE AREA ----	
 	}
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
		...
		rep.addResultExpected("Field: " + _expectedField);
/////////////////////////// END OF COMMON CHANGE AREA ----			
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
			...
			//one of tried open  operation was successfully
				...
				{				
				// perform the check						
					boolean fieldPresence = form.hasParameterNamed(_expectedField);
					if (fieldPresence)
					{
						rep.addMyResultGood("The form has the field expected"); //test passed to Report								
						_finalResult = "PASSED"; // don't change: it is used for comparison
					}
					else
					{
						rep.addMyResultBad("The form hasn't this field"); //test failed to Report
