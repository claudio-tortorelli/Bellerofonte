 ...
 */
//-----------------------------------------
class CheckCharacterSet extends Single_test implements Serializable {

    /**
     * Fields
     */
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
    private String _expectedSet = "";
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
        _expectedSet = (String) parameters.elementAt(1); //read words from file test txt or xml
/////////////////////////// END OF COMMON CHANGE AREA ----
    }
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
        rep.addResultExpected(_expectedSet);
/////////////////////////// END OF COMMON CHANGE AREA ----
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
            try {
                ...
                String charSet = resp.getCharacterSet();
                // perform the test
                if (charSet.equalsIgnoreCase(_expectedSet)) {
                    rep.addMyResultGood("The character set is as expected"); //test passed to Report
                    _finalResult = "PASSED"; // don't change: it is used for comparison
                } else {
                    rep.addMyResultBad("The character has another value: " + charSet); //test failed to Report
