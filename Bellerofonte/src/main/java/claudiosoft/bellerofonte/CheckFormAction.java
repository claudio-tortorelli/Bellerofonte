 ...
 */
//-----------------------------------------
class CheckFormAction extends Single_test implements Serializable {
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
        ...
        _expectedAction = (String) parameters.elementAt(2); //read words from file test txt or xml
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
        ...
        rep.addResultExpected("Action: " + _expectedAction);
/////////////////////////// END OF COMMON CHANGE AREA ----
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
            try {
                ...
                if (form != null) {
                    ...
                    if (act.equalsIgnoreCase(_expectedAction)) {
                        rep.addMyResultGood("The form's action is as expected"); //test passed to Report
                        _finalResult = "PASSED"; // don't change: it is used for comparison
                    } else {
                        rep.addMyResultBad("The form's has another value: " + act); //test failed to Report
