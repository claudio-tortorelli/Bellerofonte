...
class CheckTable extends Single_test implements Serializable
{
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----	
			...
			// perform the check						
				...
				if (table != null)
				{								
					rep.addMyResultGood("The table is present in this page"); //test passed to Report								
					_finalResult = "PASSED"; // don't change: it is used for comparison
				}						
				else 
				{
					rep.addMyResultBad("The table isn't present"); //test failed to Report
