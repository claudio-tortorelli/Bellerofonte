 ...
 */
//-----------------------------------------
class CheckFormContent extends Single_test implements Serializable {
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
    ...
    private String _expectedFieldValue = "";
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
        ...
        _expectedFieldValue = (String) parameters.elementAt(3); //read words from file test txt or xml
/////////////////////////// END OF COMMON CHANGE AREA ----
    }
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
        ...
        rep.addResultExpected("Field value: " + _expectedFieldValue);
/////////////////////////// END OF COMMON CHANGE AREA ----
...
/////////////////////////// BELOW CAN CHANGE FROM TEST TO TEST ----
            try {
                ...
                if (form != null) {
                    ...
                    if (fValue != null) {
                        if (fValue.equalsIgnoreCase(_expectedFieldValue)) {
                            rep.addMyResultGood("The field has the expected value"); //test passed to Report
                            _finalResult = "PASSED"; // don't change: it is used for comparison
                        } else {
                            rep.addMyResultBad("The field has another value: " + fValue); //test failed to Report
                            _finalResult = "FAILED"; // don't change: it is used for comparison
                        }
                    } else {
                        rep.addMyResultBad("Field not found");
                        _finalResult = "FAILED";
                    }
                } else {
                    rep.addMyResultBad("The parameters aren't correct to open form");
                    _finalResult = "FAILED";
                }
